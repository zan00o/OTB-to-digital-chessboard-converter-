...
\title{Automating Chess Analysis: Image-to-FEN Conversion with AI}

\author{\IEEEauthorblockN{Ryan Lopez}
\IEEEauthorblockA{\textit{Dept. Science and Engineering} \\
\textit{San Francisco State University}\\
San Francisco, USA}
\and
\IEEEauthorblockN{Trenton Tong-Seely}
\IEEEauthorblockA{\textit{Dept. Science and Engineering} \\
\textit{San Francisco State University}\\
San Francisco, USA}
}
...
\begin{figure}[htbp]
\centerline{\includegraphics[width=\linewidth]{classifier.curves.png}}
\caption{Training curves saved by the training script.}
\label{fig:curves}
\end{figure}

\begin{figure}[htbp]
\centerline{\includegraphics[width=\linewidth]{classifier.confusion.png}}
